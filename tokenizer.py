...
from data import train_path, de_tokenizer_path, en_tokenizer_path, de_txt_path, en_txt_path
import pandas as pd
...
def make_tokenizers():
    for l in ["de", "en"]:
        ...
        trainer = BpeTrainer(vocab_size=30257, special_tokens=["<s>", "<pad>", "</s>", "<unk>", "<mask>"], initial_alphabet=pre_tokenizers.ByteLevel.alphabet())
